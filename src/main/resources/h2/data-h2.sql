INSERT INTO mocker.resource_tag(id, "value") VALUES('398ddf77-8012-4767-84aa-87ad194d3ac9', 'EC');
INSERT INTO mocker.resource_tag(id, "value") VALUES('261af795-2652-401e-a9c2-dcc160041bf6', 'GPD');
INSERT INTO mocker.resource_tag(id, "value") VALUES('eaa80a30-2992-47fc-b607-4a248d03066b', 'ORGS ENROLLMENT');

INSERT INTO mocker.rule_tag(id, "value") VALUES('88513e6d-7229-43ea-96b5-f83ffd96d5f5', 'MAIN RULE');



INSERT INTO mocker.mock_resource(id, subsystem_url, resource_url, http_method, "name", is_active)
VALUES(4286553979, 'gpd-reporting-orgs-enrollment/api/v1', 'organizations/77777777777', 'GET', 'Get enrolled organization with ID 77777777777', true);
...
VALUES('6c08a21c-6a92-4f6b-a1e1-bf68c4e099c9', 'Main rule', 1, true, 4286553979, '26e05a1f-9621-4e24-a57d-28694ff30306');
...
VALUES(4286553979, '398ddf77-8012-4767-84aa-87ad194d3ac9');
INSERT INTO mocker.mock_resource_tag(mock_resource_id, tag_id)
VALUES(4286553979, '261af795-2652-401e-a9c2-dcc160041bf6');
INSERT INTO mocker.mock_resource_tag(mock_resource_id, tag_id)
VALUES(4286553979, 'eaa80a30-2992-47fc-b607-4a248d03066b');
