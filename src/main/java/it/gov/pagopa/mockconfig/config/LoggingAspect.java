...
public class LoggingAspect {
  ...
  @Pointcut("execution(* it.gov.pagopa.mockconfig.repository..*.*(..))")
  public void repository() {
    // all repository methods
  }

  @Pointcut("execution(* it.gov.pagopa.mockconfig.service..*.*(..))")
  public void service() {
    // all service methods
  }

  @Pointcut("execution(* it.gov.pagopa.mockconfig.exception.ErrorHandler.*(..))")
