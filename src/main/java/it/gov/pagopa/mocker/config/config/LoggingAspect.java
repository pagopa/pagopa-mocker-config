...
public class LoggingAspect {
  ...
  @Pointcut("execution(* it.gov.pagopa.mocker.config.repository..*.*(..))")
  public void repository() {
    // all repository methods
  }

  @Pointcut("execution(* it.gov.pagopa.mocker.config.service..*.*(..))")
  public void service() {
    // all service methods
  }

  @Pointcut("execution(* it.gov.pagopa.mocker.config.exception.ErrorHandler.*(..))")
